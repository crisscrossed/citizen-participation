  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved initiative as @initiative" do
        ...
        post :create, {:initiative => { "title" => "invalid value" }}, valid_session
        assigns(:initiative).should be_a_new(Initiative)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested initiative" do
        ...
        Initiative.any_instance.should_receive(:update_attributes).with({ "title" => "MyText" })
        put :update, {:id => initiative.to_param, :initiative => { "title" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the initiative as @initiative" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Initiative.any_instance.stub(:save).and_return(false)
        put :update, {:id => initiative.to_param, :initiative => { "title" => "invalid value" }}, valid_session
        assigns(:initiative).should eq(initiative)
      end
